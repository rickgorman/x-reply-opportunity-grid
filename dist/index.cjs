...
__export(index_exports, {
  DEFAULT_COLUMN_BREAKPOINTS: () => DEFAULT_COLUMN_BREAKPOINTS,
  DEFAULT_FRESHNESS_HALF_LIFE_HOURS: () => DEFAULT_FRESHNESS_HALF_LIFE_HOURS,
  DEFAULT_GRID_GAP: () => DEFAULT_GRID_GAP,
  DEFAULT_INTEREST_LEXICON: () => DEFAULT_INTEREST_LEXICON,
  DEFAULT_MAIN_INLINE_PAD: () => DEFAULT_MAIN_INLINE_PAD,
  DEFAULT_MAX_COLUMNS: () => DEFAULT_MAX_COLUMNS,
  DEFAULT_MIN_CARD_WIDTH: () => DEFAULT_MIN_CARD_WIDTH,
  DEFAULT_PREVIEW_LINES: () => DEFAULT_PREVIEW_LINES,
  DEFAULT_ROOM_HALF_LIVES: () => DEFAULT_ROOM_HALF_LIVES,
  DEFAULT_SCORE_THRESHOLDS: () => DEFAULT_SCORE_THRESHOLDS,
  DEFAULT_SCORE_WEIGHTS: () => DEFAULT_SCORE_WEIGHTS,
  DEFAULT_STORAGE_KEY: () => DEFAULT_STORAGE_KEY,
  ReplyOpportunityGrid: () => ReplyOpportunityGrid,
  columnCountForWidth: () => columnCountForWidth,
  scoreReplyOpportunity: () => scoreReplyOpportunity,
...
var paths = {
  replies: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.5 8.5 0 0 1 8 8v.5Z" }),
  reposts: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m2 7 4-4 4 4M6 3v13a3 3 0 0 0 3 3h3m10-2-4 4-4-4m4 4V8a3 3 0 0 0-3-3h-3" }),
  likes: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1.1-1.1a5.5 5.5 0 0 0-7.8 7.8L12 21l8.8-8.6a5.5 5.5 0 0 0 0-7.8Z" }),
  views: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4 20v-8m5 8V4m6 16V8m5 12V2" }),
  verified: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: "currentColor", stroke: "none", d: "m12 1 3 2.2 3.7.4 1.1 3.6 2.2 3-1.1 3.6.4 3.7-3.3 1.7-2.2 3-3.6-1-3.6 1-2.2-3L3.1 17l.4-3.7-1.1-3.6 2.2-3 1.1-3.6 3.7-.4Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { stroke: "#fff", d: "m7.5 11.5 3 3 6-6" })
  ] })
};
function Icon({ type }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.75", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", focusable: "false", children: paths[type] });
}
...
function useTextPreview(text, lines) {
  ...
  const [preview, setPreview] = (0, import_react.useState)({ text, hiddenWords: 0 });
...
function useVisited(key) {
  const [state, setState] = (0, import_react2.useState)({ key, visits: {}, unavailable: false });
  const current = (0, import_react2.useRef)(state);
  ...
  const markVisited = (0, import_react2.useCallback)((id) => {
    const saved = readVisits(key);
...
function Avatar({ tweet, index }) {
  const [failedUrl, setFailedUrl] = (0, import_react3.useState)();
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: `avatar avatar-${index % 5}`, "aria-hidden": "true", children: [
    tweet.name.trim().split(/\s+/u).slice(0, 2).map((part) => [...part][0]).join(""),
    tweet.avatarUrl && failedUrl !== tweet.avatarUrl && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: tweet.avatarUrl, alt: "", loading: "lazy", referrerPolicy: "no-referrer", onError: () => setFailedUrl(tweet.avatarUrl) })
  ] });
}
function TweetCard({ tweet, index, score, now, previewLines, visitedAt, onVisit }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: `tweet-card opportunity-${score.label.toLowerCase()}${visitedAt ? " is-visited" : ""}`, "data-id": tweet.id, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("a", { className: "card-link", href, target: "_blank", rel: "noopener noreferrer", onClick: visit, onAuxClick: visit, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "author", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Avatar, { tweet, index }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "author-details", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "author-identity", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "author-name", title: tweet.name, children: tweet.name }),
            tweet.verified && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "verified-badge", role: "img", "aria-label": "Verified account", title: "Verified account", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Icon, { type: "verified" }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "author-meta", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "author-handle", title: `@${tweet.handle}`, children: [
              "@",
              tweet.handle
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "aria-hidden": "true", children: "\xB7" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("time", { className: "tweet-time", dateTime: tweet.createdAt, title: new Date(tweet.createdAt).toUTCString(), children: relativeTime(tweet.createdAt, now) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "opportunity-score", role: "img", title: score.explanation, "aria-label": score.explanation, children: [
          score.label,
          " \xB7 ",
          score.score
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "account-glance", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { title: `${tweet.following.toLocaleString("en-US")} following`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: countFormatter.format(tweet.following) }),
          " following"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "aria-hidden": "true", children: "\xB7" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { title: `${tweet.followers.toLocaleString("en-US")} followers`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: countFormatter.format(tweet.followers) }),
          " followers"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "aria-hidden": "true", children: "\xB7" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { title: joined, children: joined })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "tweet-body-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { id: bodyId, className: "tweet-body", children: expanded ? tweet.body : preview.text }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { ref: preview.measureRef, className: "tweet-body tweet-measure", "aria-hidden": "true" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "sr-only", children: "Opens on X in a new tab." })
    ] }),
    preview.hiddenWords > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "expand-button", "aria-expanded": expanded, "aria-controls": bodyId, onClick: () => setExpanded((value) => !value), children: expanded ? "Show less" : `Show more [${preview.hiddenWords} more words]` }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "tweet-metrics", role: "group", "aria-label": "Post metrics", children: metricTypes.map((type) => {
      const label = `${tweet.metrics[type].toLocaleString("en-US")} ${type}`;
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "metric", role: "img", "aria-label": label, title: label, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Icon, { type }),
        countFormatter.format(tweet.metrics[type])
      ] }, type);
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "card-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `source-badge source-${tweet.source}`, children: tweet.source === "candidate" ? "Candidate" : "Feed" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "visit-status", title: visitedAt ? `Opened ${new Date(visitedAt).toUTCString()}` : "Open this post in a new tab", children: visitedAt ? "Visited \u2713" : "Open on X \u2197" })
    ] })
  ] });
}
function ReplyOpportunityGrid({
  ...
  const [mountedAt, setMountedAt] = (0, import_react3.useState)(null);
  ...
  const records = (0, import_react3.useMemo)(() => uniqueTweets(tweets), [tweets]);
  const scores = (0, import_react3.useMemo)(() => records.map((tweet) => scoreReplyOpportunity(tweet, { ...scoreOptions, now })), [records, scoreOptions, now]);
  ...
  const callbackRef = (0, import_react3.useRef)(onVisitedChange);
  (0, import_react3.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { id, className: `x-reply-opportunity-grid${className ? ` ${className}` : ""}`, style, "aria-label": ariaLabel, children: [
    storageUnavailable && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "storage-notice", role: "status", children: "Browser storage is unavailable or unreadable. Visited posts will only stay marked for this page session." }),
    records.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "empty-state", role: "status", children: emptyState }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "tweet-grid", children: columns.map((column, col) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "tweet-col", "data-col": col, children: column.map(({ tweet, index }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TweetCard, { tweet, index, score: scores[index], now, previewLines, visitedAt: Object.hasOwn(visits, tweet.id) ? visits[tweet.id] : void 0, onVisit: markVisited }, tweet.id)) }, col)) })
  ] });
}
